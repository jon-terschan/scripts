# NOTES 
# My third attempt to parallelize and second attempt at an array job.
# I know realized I need some kind of buffer or halo to get spatial context from the neighborhood.
# This was my first attempt to deal with it, by creating a tile index, calculating the neighborhood files.
# I don't quite remember what was wrong with it, but for some reason or the other it didnt quite work, perhaps
# the memory was a problem.
...
pipeline <- del + dtm + dsm + norm + chm + chmfill
