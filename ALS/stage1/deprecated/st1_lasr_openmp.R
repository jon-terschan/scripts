# NOTES
# My first attempt to parallelize the pipeline
# using native methods (OpenMP multithreading in C++). This uses the lasR package's concurrent file strategy, running the pipeline
# over 1 file / thread.
# It works, but scales poorly too many files, which is why I pivoted
# towards using array jobs. At that point I was thinking my task was "embarrassingly parallel".
